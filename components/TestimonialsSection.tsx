  ...
  const testimonials = [
    {
      name: 'Selim M.',
      role: locale === 'fr'
        ? 'Responsable des évènements – 50 ans de la Faculté de Pharmacie de Monastir (FPHM)'
        : 'Event manager – 50th anniversary of the Faculty of Pharmacy of Monastir (FPHM)',
      content: locale === 'fr'
    ...
    },
    {
      name: 'Karim',
      role: locale === 'fr'
        ? 'Fondateur de l\'application de paiement Dinary'
        : 'Founder of the Dinary payment application',
      content: locale === 'fr'
